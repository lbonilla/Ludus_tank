...
package stats_ludus
{
	...
	{	
		...
		private var _theme:Theme = new Theme();
		/**
		 * <b>Hi-ReS! Stats</b> FPS, MS and MEM, all in one.
		 * 
		...
		private function init(e : Event) : void
		{
			...
			graphics.beginFill(_theme.bg, 1);
			graphics.lineStyle(1, 0x6c96ff, 0.6);
			graphics.drawRoundRect(0, 0, 70, 55, 3);
			graphics.endFill();
			...
			_style.setStyle("xml", {fontSize:'10px', fontFamily:'_sans', leading:'-2px'});
			...
			bitmap = new Bitmap( _graph = new BitmapData(70, 60, false, _theme.bg) );
			bitmap.y = 50;
			bitmap.alpha = 1;
