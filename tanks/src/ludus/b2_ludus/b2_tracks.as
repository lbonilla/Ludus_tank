package ludus.b2_ludus
{
	...
	public class b2_tracks
	{
		...
		public function b2_tracks(world:b2_world, 
								  tank:b2Body, 
								  width:Number, 
								  height:Number, 
								  radius:Number, 
								  ...
								  restitution:Number)
		{
			...
			//20
			//60
			this.xpos = (tank.GetPosition().x * globals.WORLD_SCALE) + (30);
			this.ypos = (tank.GetPosition().y * globals.WORLD_SCALE) + (60);
