package ludus.b2_ludus.Decorators
{
	...
	public class Turret extends Weapon
	{
		...
		///Constructor
		public function Turret(pactor:IActor, pbody:Sprite, pxpos:Number,pypos:Number, pbodyInternalName:String, pbulletBody:Sprite )
		{
			super(pactor.stage, pactor,pactor.virtualWorld,  pbody,pxpos,pypos,pbodyInternalName);
			strikeCapability = 5;
