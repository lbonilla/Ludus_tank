package ludus.b2_ludus.Actors
{
	...
	public class LandVehicle extends Vehicle
	{
		...
		//Constructor
		public function LandVehicle(pname:String,pstage:Stage,pvirtualWorld:b2World, pbody:Sprite,
									pbodyInternalName:String,  px:Number, 
									py:Number, prightWheel_mc:Sprite,pleftWheel_mc:Sprite)
		{
			super(pname,pstage,pvirtualWorld,pbody,pbodyInternalName,px,py);
			_rightWheel_mc = prightWheel_mc;
			_leftWheel_mc = pleftWheel_mc;
			stage.addChild(_rightWheel_mc);
			stage.addChild(_leftWheel_mc);
		}
