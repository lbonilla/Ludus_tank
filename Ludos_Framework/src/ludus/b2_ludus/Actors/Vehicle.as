...
{	
	...
	public  class Vehicle extends Actor
	{
		...
		//Deberia ser privado 
		public function Vehicle(pname:String,pstage:Stage,pvirtualWorld:b2World, pbody:Sprite,pbodyInternalName:String, px:Number, py:Number)
		{ 
			//TODO: implement function
			super(pname,pstage,pvirtualWorld,pbody);
			body= pbody;
