...
public class stage_1 extends Sprite
{
	//Mc's
	...
	private function init(){
		...
		actor = new AerialVehicle(stage,world,new blueTank_mc(),"tank",150,200,messageObserver);
		...
		actor = new Healthbar(stage,actor,world) ;
		actor = new ControlPanel(stage,actor,world,200,5);
		//actor = new Tracks(b2_tracks(world, actor., 5,  1.5, 25, 16, 1, 2, 0, track_xpos, track_ypos, type);
